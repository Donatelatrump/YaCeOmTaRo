...
{
    public partial class Combinaciones_Permutaciones : Form
    {
        public Combinaciones_Permutaciones()
        {
            InitializeComponent();
            panel1combi.Hide();
            panel2combi.Hide();
        ...
        private void button1_Click(object sender, EventArgs e) //boton para cargar todos los casos de permutacion o combinacion 
        {
        ...
        private void button2_Click(object sender, EventArgs e) //calcula el primer caso de combinacion con repeticion
        {
        ...
        private void button4_Click(object sender, EventArgs e) //calcula el 2do caso de combinacion sin repeticion
        {
        ...
        private void button5_Click(object sender, EventArgs e) //boton de retorno
        {
            panel2combi.Hide();
            panel1combi.Hide();
        }
